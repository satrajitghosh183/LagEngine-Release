"""
Author: Eckert ZHANG
Date: 2021-11-03 16:59:12
LastEditTime: 2021-11-11 11:09:47
LastEditors: Eckert ZHANG
FilePath: /PIRender/generators/face_model_imgcdn.py
Description: 
"""
import functools
import numpy as np
...
from preprocess.generators.cnn_tools_imgcdn import ResNet18, BasicBlock
...
class FaceGenerator(nn.Module):
    def __init__(self, mapping_net, warpping_net, editing_net, common):
        ...
        self.mapping_net = ResNet18(BasicBlock,
                                    out_channel=mapping_net.descriptor_nc)
        self.warpping_net = WarpingNet(**warpping_net, **common)
        self.editing_net = EditingNet(**editing_net, **common)

    def forward(self, input_image, cdn_image, stage=None):
        # num_img = cdn_image.shape[0]
        # for i in range(num_img):
        #     box =
        driving_source = cdn_image
        if stage == 'warp':

...
LastEditTime: 2021-12-07 15:32:07
            ...
            for layer, weight in zip(self.layers, self.weights):
                ...
                if self.use_style_loss and scale == 0:
                    style_loss += self.criterion(
                        self.compute_gram(input_feature),
...
def _inception_v3(layers):
    ...
    network = nn.Sequential(inception.Conv2d_1a_3x3, inception.Conv2d_2a_3x3,
...
def _resnet50(layers):
    ...
    network = nn.Sequential(resnet50.conv1, resnet50.bn1, resnet50.relu,
                            resnet50.maxpool, resnet50.layer1, resnet50.layer2,
                            resnet50.layer3, resnet50.layer4, resnet50.avgpool)
    layer_name_mapping = {
        4: 'layer_1',
        5: 'layer_2',
        6: 'layer_3',
